...
def generate_html_report(
    ...
    每次生成 HTML 后会：
    1. 保存时间戳快照到 {output_dir}/html/日期/时间.html（历史记录）
    2. 复制到 {output_dir}/html/latest/{mode}.html（最新报告）
    3. 复制到 {output_dir}/index.html（入口）
