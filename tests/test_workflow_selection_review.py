...
class SelectionReviewExportTest(unittest.TestCase):
    ...
    def test_export_selection_outbox_writes_native_funnel_artifacts(self):
        ...
        self.assertIn("OpenAI 发布新代理", review_text)
        ...
        self.assertEqual(llm_payload["llm"]["decisions"][0]["title"], "OpenAI 发布新代理")
        self.assertEqual(llm_payload["llm"]["decisions"][0]["score"], 0.95)
        self.assertEqual(llm_payload["llm"]["decisions"][0]["source_id"], "hackernews")
